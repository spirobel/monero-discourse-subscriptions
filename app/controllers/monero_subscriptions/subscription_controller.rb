module MoneroDiscourseSubscriptions
    class SubscriptionController < ::ApplicationController
        ...
        def mysubscriptions
            ...
            open_invoices =  MoneroInvoice.joins(:monero_payments).distinct.where(paid: false, recipient: current_user).to_json( :include => [:monero_payments, :monero_product, :monero_plan])
